...
class ClassAssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_assignment" do
    assert_difference('ClassAssignment.count') do
      post class_assignments_url, params: { class_assignment: { class_name: @class_assignment.class_name, course_id: @class_assignment.course_id, due_date: @class_assignment.due_date, professor_id: @class_assignment.professor_id } }
    end
  ...
  test "should update class_assignment" do
    patch class_assignment_url(@class_assignment), params: { class_assignment: { class_name: @class_assignment.class_name, course_id: @class_assignment.course_id, due_date: @class_assignment.due_date, professor_id: @class_assignment.professor_id } }
